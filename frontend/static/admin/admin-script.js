document.addEventListener('DOMContentLoaded', () => {
    ...
    let state = {
        orders: [],
        menu: {},
        categories: [], // Lista para guardar as categorias
    ...
    async function fetchCategoriesAndProducts() {
        try {
            ...
            showNotification("Erro: Não foi possível carregar os dados do servidor.", "error");
        }
    }
    ...
    function toggleSidebar() { sidebar.classList.toggle('visible'); sidebarOverlay.classList.toggle('active'); }
    ...
    document.addEventListener('click', (e) => {
        ...
        if (state.currentView === 'cardapio') { 
            ...
            const editCategoryBtn = target.closest('.btn-edit-category');
            if (editCategoryBtn) { renameCategory(parseInt(editCategoryBtn.dataset.categoryId)); return; }
            const toggleVisibilityBtn = target.closest('.btn-toggle-visibility');
            if (toggleVisibilityBtn) { toggleCategoryVisibility(parseInt(toggleVisibilityBtn.dataset.categoryId)); return; }
        }
